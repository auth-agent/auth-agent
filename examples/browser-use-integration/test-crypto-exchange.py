"""
Test script: Authenticate with Crypto Exchange dashboard using Auth Agent (localhost).

This script tests the Auth Agent OAuth 2.1 flow on the crypto exchange demo website running locally.
...
async def main():
    """Run the Auth Agent authentication test for Crypto Exchange dashboard."""
    ...
    # Create the task for Crypto Exchange dashboard (localhost)
    task = (
        ...
        "The dashboard should show crypto trading information, portfolio data, or charts. "
    ...
    # Run the agent
    print("🚀 Starting authentication test for Crypto Exchange dashboard (localhost)...\n")
