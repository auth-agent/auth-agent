"""
Test script: Authenticate with GitHub Clone website using Auth Agent (localhost).

This script tests the Auth Agent OAuth 2.1 flow on the GitHub clone demo website running locally.
...
async def main():
    """Run the Auth Agent authentication test for GitHub Clone website."""
    ...
    # Create the task for GitHub Clone website (localhost)
    task = (
        ...
        "The dashboard should show repository information or user/agent data. "
    ...
    # Run the agent
    print("🚀 Starting authentication test for GitHub Clone website (localhost)...\n")
