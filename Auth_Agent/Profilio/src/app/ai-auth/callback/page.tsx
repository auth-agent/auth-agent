  ...
  useEffect(() => {
    const handleAuth = async () => {
      try {
        ...
        console.log('[Auth Agent Callback] Authorization code received:', code?.substring(0, 30) + '...')
        console.log('[Auth Agent Callback] Code verifier retrieved from sessionStorage:', codeVerifier?.substring(0, 30) + '...')
        console.log('[Auth Agent Callback] Code verifier length:', codeVerifier?.length)
