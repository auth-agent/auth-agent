...
try {
  const authorizationUrl = 'https://clever-pika-819.convex.site/authorize?client_id=...&redirect_uri=...';
...
try {
  ...
  const authorizationUrl = 'https://clever-pika-819.convex.site/authorize?client_id=...';
...
const sdk = new AuthAgentAgentSDK({
  authServerUrl: 'https://clever-pika-819.convex.site',
  agentId: 'agent_xxx',
  agentSecret: process.env.AGENT_SECRET!,
