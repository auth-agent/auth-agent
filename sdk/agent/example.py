...
Example:
    python example.py "https://clever-pika-819.convex.site/authorize?client_id=client_xxx&redirect_uri=..."
"""
...
async def main():
    ...
    if len(sys.argv) < 2:
        ...
        print('\nExample:')
        print('  python example.py "https://clever-pika-819.convex.site/authorize?client_id=client_xxx&redirect_uri=..."')
        sys.exit(1)
